...
$isEditable = false;
$vocab=array();
$vocab['en-gb']['more']='read more';
$vocab['az-az']['more']='ətraflı';
$vocab['ru-ru']['more']='подробнее';
 ...
 <div class="row">
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
					...
					<div class="shorttext"><?php echo mb_substr(strip_tags($article->introtext),0,500); ?>...</div>
<div class="panel-footer text-right"><a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid, $article->language)); ?>"><?=$vocab[$lang]['more'];?></a></div>
